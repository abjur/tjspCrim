...
Figura: Distribuição dos assuntos em cada câmara
```{r}
d_cposg_cjsg %>%
  count(subject, court) %>% 
...
Figura: Distribuição dos assuntos em cada câmara, base homogeneizada.
```{r}
...
Figura: Proporções resultados dos processos por mês.
```{r}
d_cposg_cjsg %>% 
